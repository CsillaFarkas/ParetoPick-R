...
def main():
    ...
    # Subset the data to only include the columns for PCA
    ...
    if handle_outliers_boolean == 1:
        ...
        for num_components in range(min_components, max_components + 1):
            ...
            for d in non_integer_range(deviations_min, deviations_max+deviations_step, deviations_step):
                for c in range(count_min, count_max+1):
                    ...
                    # Perform k-medoids clustering multiple times and select the best result based on highest silhouette score
        ...
        final_raw_data_no_outliers.loc[raw_data_no_outliers.index.isin(representative_solutions_index), 'Representative_Solution'] = 1
        ...
        out_file_path = output_path / "kmedoid_data_w_clusters_representativesolutions_outliers_outliergraph.csv"
        ...
        for num_components in range(min_components, max_components + 1):
            ...
            # Perform k-medoids clustering multiple times and select the best result
